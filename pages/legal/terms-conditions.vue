      ...
      <div class="text-white">
        ...
        <div class="text-gray-400 prose md:prose-lg prose-yellow">
          <p>By downloading or using the app, these terms will automatically apply to you – you should make sure
            ...
            property rights related to it, still belong to Andronix.</p>
          <p>Andronix is committed to ensuring that the app is as useful and efficient as possible. For that reason, we
            ...
            paying for.</p>
          <p>The Andronix App app stores and processes personal data that you have provided to us, in order to provide
            ...
            could mean that the Andronix App app won’t work properly or at all.</p>
          ...
          <p>You should be aware that there are certain things that Andronix will not take responsibility for. Certain
          ...
          <p>Along the same lines, Andronix cannot always take responsibility for the way you use the app i.e. You need
            to make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail
            the Service, Andronix cannot accept responsibility.</p>

          <p>With respect to Andronix’s responsibility for your use of the app, when you’re using the app, it’s
          ...
          <p>At some point, we may wish to update the app. The app is currently available on Android – the requirements
