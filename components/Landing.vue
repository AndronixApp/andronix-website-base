<template>
  <div class="relative h-screen mt-8 lg:mt-0 bg-background w-full lg:px-24">
    <div class="grid grid-cols-1 ms:grid-cols-2 lg:grid-cols-3 justify-between ">
      <div
        class="mt-6 self-stretch text-center lg:text-left lg:self-center lg:mt-16 lg:grid-cols-1 justify-self-center lg:justify-self-start order-2 lg:order-1"
      >
        <div xyz="fade big top-100% duration-10" class="xyz-in"
        >
          <h1 class="text-white text-4xl lg:text-5xl font-black">The Power of
            <strong class="text-primary-400">Linux</strong> on
            Android.</h1>
        </div>

        <div xyz="fade small bottom-100% ease-out-back duration-10 delay-10" class="xyz-in">
          ...
          <div class="flex flex-wrap mt-8 justify-center lg:justify-start items-center lg:items-start">
            <div class="min-w-max bg-gradient-to-r from-violet to-primary-600 px-3 rounded py-1 mt-4 flex mr-4 xyz-in"
                 xyz="fade big left ease-out-back delay-20"
            >
              <img
            ...
            <div class="min-w-max bg-gray-600 px-3 rounded py-1 mt-4 mr-4 flex xyz-in"
                 xyz="fade big right ease-out-back delay-15"
            >
